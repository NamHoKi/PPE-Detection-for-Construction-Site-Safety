                        ...
                        if len(det):
                            ...
                            if len(outputs) > 0:
                                ...
                                for r in person_result_list:
                                    ...
                                    if r[4] == 'Danger':
                                        if str(id) in self.danger_dic :
                                            dict_start_time, dict_last_time = self.danger_dic[str(id)]
                                            self.danger_dic[str(id)] = [dict_start_time, time.time()]
                                        else :
                                            self.danger_dic[str(id)] = [time.time(), time.time()]

                                        # for key, value in self.danger_dic.items():
                                        #     start_time, last_time = value
                                        ...
                                        #             self.reset_danger()
                                        #     else:
                                        #         if time.time() - last_time >= self.reset_limit_time:
                                        #             del self.danger_dic[key]
